...
Changing sex and education to factor variables, age and BMI to integer
variables
...
![](p8105-hw3_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
...
```
    ...
    ## # … with 240 more rows, and 1,431 more variables: min11 <dbl>, min12 <dbl>,
    ## #   min13 <dbl>, min14 <dbl>, min15 <dbl>, min16 <dbl>, min17 <dbl>,
    ## #   min18 <dbl>, min19 <dbl>, min20 <dbl>, min21 <dbl>, min22 <dbl>,
    ## #   min23 <dbl>, min24 <dbl>, min25 <dbl>, min26 <dbl>, min27 <dbl>,
    ## #   min28 <dbl>, min29 <dbl>, min30 <dbl>, min31 <dbl>, min32 <dbl>,
    ## #   min33 <dbl>, min34 <dbl>, min35 <dbl>, min36 <dbl>, min37 <dbl>,
    ## #   min38 <dbl>, min39 <dbl>, min40 <dbl>, min41 <dbl>, min42 <dbl>, …
...
```
    ...
    ## # A tibble: 229 × 1,446
    ##     seqn sex     age   BMI educa…¹  min1   min2   min3  min4   min5   min6  min7
    ...
    ##  9 62189 2        30  22.4 3       2.81  0.195  0.163  0     0.144  0.180  0.870
    ## 10 62199 1        57  28   3       0.031 0.0359 0.0387 0.079 0.109  0.262  0.878
    ## # … with 219 more rows, 1,434 more variables: min8 <dbl>, min9 <dbl>,
...
![](p8105-hw3_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
